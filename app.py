	...
	try:
		with tab1:
			...
			for idx, row in df.iterrows():
				...
				display_song(idx+1, track_id=track_id, track_name=row.track_name, artist=row.artist_name, similarity=row.similarity, time_similarity=row.time_similarity, freq_similarity=row.frequency_similarity)
		with tab2:
